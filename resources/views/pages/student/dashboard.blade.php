    ...
    <div class="bg-gradient-to-r from-white to-gray-50 rounded-md border border-gray-200 p-6 shadow-lg">
        ...
        <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 flex justify-center md:justify-end mt-6 md:mt-0">
                <img class="w-36 h-36 rounded-full" src="{{ auth()->user()->profile_picture ? url('storage/' . auth()->user()->profile_picture) : '/assets/images/default-profile.png' }}" alt="{{ auth()->user()->name }}">
            </div>
        </div>
    </div>
