<nav class="relative px-4 py-4 flex justify-between items-center bg-white max-w-6xl mx-auto rounded-lg">
                ...
                <ul x-show="open" @click.away="open = false" class="dropdown-menu shadow-md shadow-black/5 z-30 absolute right-0 mt-2 w-48 bg-white rounded-md border border-gray-100">
                    <li>
                        ...
                        <a href="{{ route($route) }}" class="py-2 px-4 flex items-center hover:bg-gray-50">
                            ...
                            <span class="ml-2 text-sm font-medium text-gray-700">Mon profil</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('settings') }}" class="py-2 px-4 flex items-center hover:bg-gray-50">
                            <svg class="w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.333 0-3 2-3 4s1.667 4 3 4 3-2 3-4-1.667-4-3-4z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.24 7.76a6 6 0 011.55 3.26M9.1 16.9A6 6 0 015.76 12M3 21l1.55-1.55M21 3l-1.55 1.55" />
                            </svg>
                            <span class="ml-2 text-sm font-medium text-gray-700">Paramètres</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('notifications') }}" class="py-2 px-4 flex items-center hover:bg-gray-50">
                            <svg class="w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 18v2a3 3 0 01-6 0v-2M17 8a6 6 0 10-10 0v5l-1.29 1.29a1 1 0 00-.21.33 1 1 0 00.21.89l.29.29h12l.29-.29a1 1 0 00.21-.89 1 1 0 00-.21-.33L17 13V8z" />
                            </svg>
                            <span class="ml-2 text-sm font-medium text-gray-700">Notifications</span>
                        </a>
                    </li>
                    <li class="border-t border-gray-200">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="w-full text-left py-2 px-4 flex items-center hover:bg-gray-50">
                                <svg class="w-5 h-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7" />
                                </svg>
                                <span class="ml-2 text-sm font-medium text-gray-700">Déconnexion</span>
                            </button>
                        </form>
                    </li>
                </ul>
  ...
  <div id="mobileMenu" class="navbar-menu relative z-50 hidden">
